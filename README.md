...
> [!NOTE]
> **Extension is intended mainly for use by the students of CMC MSU (ВМК МГУ) faculty**
> **Extension doesn't currently support full masm specification, only a SUBSET of the language**  
